...
#
# Purpose:
# To test available video resources with gstreamer and ffplay
# and provide the results on the console and in a log file.
#
# Summary:
# Enumerates /dev/video* devices and tests them with ffplay and gstreamer.
# Operator is asked to confirm (y/n) whether video was seen.
# Writes a log file and prints a summary report at the end.
###################################################################################
