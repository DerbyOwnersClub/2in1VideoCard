...
class BorderlessVideoWindow(Gtk.Window):
    def __init__(self):
        ...
        # Pipeline with videocrop on each feed (half-width per feed)
        pipeline_str = f"""
        ...
        v4l2src device={video_device1} io-mode=2 do-timestamp=true ! \
            ...
            videoscale ! video/x-raw,width={WINDOW_WIDTH // 2},height={WINDOW_HEIGHT} ! comp.sink_0 \
        v4l2src device={video_device2} io-mode=2 do-timestamp=true ! \
            ...
            videoscale ! video/x-raw,width={WINDOW_WIDTH // 2},height={WINDOW_HEIGHT} ! comp.sink_1
        """
