...
fps = sys.argv[3] if len(sys.argv) == 4 else "30"   # default to 30
...
class BorderlessVideoWindow(Gtk.Window):
    ...
    # ---- UI helper, sliders, callbacks omitted (unchanged) ----
    # keep all your crop/zoom/alpha/zorder handlers here (unchanged)
